...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T failedValue) invalidVerificationCode,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(T failedValue)? invalidVerificationCode,
...
class _$InvalidVerificationCode<T> implements InvalidVerificationCode<T> {
  const _$InvalidVerificationCode({required this.failedValue});
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.invalidVerificationCode(failedValue: $failedValue)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return invalidVerificationCode(failedValue);
  }
...
abstract class InvalidVerificationCode<T> implements ValueFailure<T> {
  const factory InvalidVerificationCode({required T failedValue}) =
